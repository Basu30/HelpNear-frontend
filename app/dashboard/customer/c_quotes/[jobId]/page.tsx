...
// import { getJobQuotes, acceptQuote } from '@/services/quotes.service'
// import type { QuoteWithProvider } from '@/services/quotes.service'
...
//               <div
//                 key={quote.id}
//                 className="bg-white border border-slate-200 rounded-3xl shadow-sm hover:shadow-md transition p-4 md:p-6"
//               >
...
//                         ⭐ {quote.average_rating} • {quote.completed_jobs} jobs completed
//                       </p>
//                     </div>
//                   </div>
...
//                       {quote.estimated_time ?? 'Not specified'}
//                     </p>
//                   </div>
//                 </div>

//                 {/* Actions */}
//                 <div className="mt-6 pt-5 border-t border-slate-200 flex flex-col sm:flex-row sm:justify-end gap-3">
//                   <button className="px-5 py-3 rounded-2xl border border-slate-300 text-slate-700 hover:bg-slate-100 transition">
//                     View Profile
//                   </button>
//                   <button
//                     onClick={() => handleAccept(quote.id)}
//                     disabled={accepting === quote.id}
//                     className="px-5 py-3 rounded-2xl bg-blue-600 text-white hover:bg-blue-700 transition disabled:opacity-50"
//                   >
